    ...
    <div className=" w-full h-screen flex items-center justify-center">
      <div className=" w-5/6 md:w-3/4 md:h-[600px] flex justify-between border border-gray-300 shadow-xl rounded-2xl">
        <div className=" md:w-1/2 h-full px-5  md:px-10 py-20 flex flex-col gap-10">
          ...
          <h1 className=" text-2xl md:text-4xl font-bold text-[#00A99D]">
            Registration Request Submitted
          </h1>
          <h1>
            Thank you for submitting your registration request. Our team will
            review your details shortly.You’ll receive an email once your
