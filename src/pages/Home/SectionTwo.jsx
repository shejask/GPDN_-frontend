    ...
    <section className="w-full h-auto lg:min-h-screen flex justify-center items-center py-5 lg:py-0 ">
      <div className="w-full h-auto lg:h-[75%] xl:h-[80%]  flex flex-col gap-16 lg:grid lg:grid-cols-2  lg:gap-x-28">
        ...
        <div className="flex flex-col  gap-3 lg:gap-5 w-full h-full">
          ...
          <p className="text-[#0C0E12] font-normal text-normal lg:text-[1.2vw] leading-tight">Discover the key benefits of being part of the Global Palliative Doctors Network. Collaborate with experts, stay updated on the latest developments, and elevate your practice with global support.</p>
