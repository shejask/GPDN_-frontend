  ...
  return (
    <section className="w-full h-auto lg:min-h-screen flex justify-center items-center py-5 lg:py-14">
        <div className=' w-full h-full flex flex-col gap-3 lg:gap-12  lg:items-center'>
            ...
            <h1 className='font-semibold text-[2rem] md:text-[2.5rem] xl:text-6xl text-black lg:text-center'>Bringing Smiles,<br className='hidden md:block lg:hidden'/> Building Connections</h1>
